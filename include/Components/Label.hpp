...
namespace SFUI {
    ...
    class Label : public Component {
        ...
        public:
            /**
             * @brief Layout properties specific to the Label component.
             */
            ...
            /**
             * @brief State properties specific to the Label component.
             */
            SFUI::PropGroup::Label::State state;

            /**
             * @brief Behavior properties specific to the Label component.
             */
        ...
        public:
             ...
             * @param propSet Set of label property groups.
             * @param children Variadic list of child components.
             */
            template<typename... Children>
            Label(SFUI::String componentID, SFUI::PropSet::Label propSet, Children&&... children) :
